...
Definition Sbox (v1 : u8) : u8 :=
  match word.word.toword v1 with
...
Definition InvSbox (v1 : u8) :=
  ...
  | 255 => wrepr U8 125 | _ => word.word0
  end%Z.

(* NOTE: that SubWord clashes with word.subword *)
...
Definition x86_AESENC          (v1 v2 : u128) : ex_tpl (w_ty U128) := ok (wAESENC v1 v2).
Definition x86_AESENCLAST      (v1 v2 : u128) : ex_tpl (w_ty U128) := ok (wAESENCLAST v1 v2).
Definition x86_AESIMC          (v1    : u128) : ex_tpl (w_ty U128) := ok (InvMixColumns v1).
